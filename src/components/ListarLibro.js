...
export default function ListarLibro() {
  ...
  const eliminarSub = async (id) => {
    const respuesta = await Axios.delete(
      "https://ganohealthy.herokuapp.com/eliminar/" + id
  ...
  const Favoritos = async (id2) => {
    ...
    const respuesta = await Axios.put(
      "https://ganohealthy.herokuapp.com/agregarfavorito/" + id,
      favorito
    ); /* cuando reciba l informacion entra tambien el id de el elemento a eliminar */
    ...
    sessionStorage.setItem(
      "contadorFavoritos",
      respuesta2.data.user2.length
    ); /* conocer el valos de cuantos datos tiene un arrays en la tabla en el mongo db */
  };
  /* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
