...
export default function ListarLibro() {
        ...
        <div className="container border border-secondary">
            ...
            <table className="table table-success table-striped">
...

                {
                    ...
                    buscar.map((libros, i) => (  /* LIBROS RECIVIRA LOS LA INFORMACION DE DATOS RECIVIDO DE SETDATOS*/

                        <tbody key={libros._id}>{/* NECESARIO CREAR UN KEY  le asigno el _id que viene por defecto del mongodb como entrada*/}
                            <tr>
                                <td >{i + 1}</td>
                                ...
                                {admin ?
                                    <td >
                                        ...
                                        <Link className="btn btn-info mr-2" to={'/editar/' + libros._id}><i class="fas fa-sync-alt"></i>
                                            Actualizar
                                         </Link>
