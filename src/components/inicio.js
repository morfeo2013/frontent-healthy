        ...
        <div class="container">
          ...
          <div className="row">
            ...
            <div className="col-sm-12 col-md-6 imagen2 text-center">
              <img className="  img-thumbnail img-fluid d-block w-100" src="https://morfeo12345678.s3-sa-east-1.amazonaws.com/fotos+ganoderma/Screenshot_20201103_093714.jpg" alt=""></img>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row mt-5 ">
            <div className="col-sm-12 text-dark">
              ...
              Obtienes el derecho a hacer uso de nuestras instalaciones físicas e infraestructura, que ponemos a tu disposición para que desarrolles el negocio, apalancado por tu patrocinador y con el respaldo de la imagen corporativa y experiencia de GANO EXCEL.


              Recibes un negocio “llave en mano”, en funcionamiento, con un nombre e imagen corporativa, una reputación y un gran potencial de crecimiento. No tienes que preocuparte de ningún proceso diferente a la gestión comercial de promoción y venta de nuestros productos. La empresa se encarga de la investigación y el desarrollo, la producción, la logística, la administración, el plan de mercadeo, las relaciones públicas y los temas legales y de impuestos.
        ...
        <div className="container">
          ...
          <div className="row mt-5">
            <div className="col-sm-12 col-md-4 text-center">
              ...
              <p className="mt-5">
                Por medio de nuestras redes y servicion, buacamos llegar a nuestros clientes de todo el pais, para llevar nuestros productos naturales de alta calidad a todas partes de Colombia
                </p>
            ...
            <div className="col-sm-12 col-md-4 text-center">
              ...
              <p className="mt-5">
                Estamos constantemente en busqueda y capacitacion de personas con deseos de desarrolarse como comercializadores independientes,fortaleziendolos y entreneandolos en el campo de los productos naturales.
                </p>
              <button className="btn btn-info text-center mb-5">
                Ver Mas <i className="fas fa-arrow-circle-right"></i>
              </button>
            ...
            <div className="col-sm-12 col-md-4 text-center">
              ...
              <p className="mt-5">
                Por medio de nustros canales de difucion, pretendemos llegar a todos los lugares de colombia yde LatinoAmerica.
                </p>
              <button className="btn btn-info text-center mb-5">
                Ver Mas <i className="fas fa-arrow-circle-right"></i>
              </button>
      ...
      <section id="galeria ">
        <div className="row mt5 no-gutters  ">
          <div className="col-sm-12 col-md-3">
            <img src="https://morfeo12345678.s3-sa-east-1.amazonaws.com/fotos+ganoderma/IMG_20201016_095423_1.jpg" alt="" className=" d-block w-100"></img>
          </div>
          <div className="col-sm-12 col-md-3 ">
            <img src="https://morfeo12345678.s3-sa-east-1.amazonaws.com/fotos+ganoderma/IMG_20201016_094411_1+(1).jpg" alt="" className=" d-block w-100"></img>
          </div>
          <div className="col-sm-12 col-md-3 ">
            <img src="https://morfeo12345678.s3-sa-east-1.amazonaws.com/fotos+ganoderma/IMG_20201016_093755_1.jpg" alt="" className=" d-block w-100"></img>
          </div>
          <div className="col-sm-12 col-md-3">
            <img src="https://morfeo12345678.s3-sa-east-1.amazonaws.com/fotos+ganoderma/IMG_20201016_102744.jpg" alt="" className=" d-block w-100"></img>
          </div>
      ...
      <section id="testimonios">
        <div className="container">
          ...
          <div className="row mt-5">
            <div className="col-sm-12 col-md-4 text-center">
              <div className="card">
                <div className="card-boddy"><p className="mt-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis nam temporibus voluptatum vitae quae. Nemo ducimus id magnam.

                   </p>
                  <cite><strong>Jhon fredy</strong></cite>
                </div>
              </div>
            </div>
            <div className="col-sm-12 col-md-4 text-center">
              <div className="card">
                <div className="card-boddy"><p className="mt-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis nam temporibus voluptatum vitae quae. Nemo ducimus id magnam.
                  ...
                  <cite><strong>Sara rios goez</strong></cite>
                </div>
              </div>
            </div>
            <div className="col-sm-12 col-md-4 text-center">
              <div className="card">
                <div className="card-boddy"><p className="mt-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis nam temporibus voluptatum vitae quae. Nemo ducimus id magnam.
                  ...
                  <cite><strong>Elizabelh goez</strong></cite>
                </div>
              </div>
            </div>
          </div>
